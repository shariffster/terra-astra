# v0.10.19 celestial depth and material correction (23 September 2026)

The user approves the candid critique of `5b4e48318c9abfed53d64bd728d26559533275f6` and explicitly includes Sun/Moon/nebula movement in relation to Earth rotation. Refine material at actual scale, expose the cloudy fold, and distinguish idle Earth spin from user inspection and independent celestial motion. Keep this same branch, version and owner-private Site with a new saved revision. Preserve earlier checkpoints, Earth/network/activity, saved values and the complete opening. The composed sky and accelerated lunar/solar/cloud motion remain illustrative. Technical checks alone are not visual acceptance.

# v0.10.19 living celestial materials (23 September 2026)

The user redirects the next pass to Sun, Moon and nebula: give the bodies living material, preserve the lunar crescent and align its light with the Sun, and correct the relationship between Earth inspection and the surrounding sky. The user rejected the initial particle-only treatment and explicitly prefers a hybrid: dynamic smoky clouds, a concentrated luminous Sun with projecting activity, and a better Moon. Restore the earlier cloud structure; particles are optional, not a requirement. Continue this branch/version/Site with a new saved revision. Preserve all earlier tags/revisions, other Sites, Earth light, network geometry/activity, saved settings, and the complete opening. This supersedes prior sky-preservation boundaries only for these three celestial bodies and their motion controls. The celestial scene remains illustrative; do not claim real-time astronomical positions, physical scale or nebular timescales.
