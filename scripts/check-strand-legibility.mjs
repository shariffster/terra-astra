...
const sources=['marine-branches','indian-branches','regional-branches','european-branches','east-asian-branches','pacific-branches'].map(n=>JSON.parse(readFileSync(new URL('../public/data/networks/'+n+'.json',import.meta.url))));
