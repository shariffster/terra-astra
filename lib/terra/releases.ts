...
export const releases = [
  ...
  },
  {
    ...
    changes: [
      ...
      'A global marine light balance gives supporting branches more presence, with longer selected Indian and Atlantic hub approaches and a rounder Horn of Africa passage. Ships and cable pulses are more present; flights and satellites keep their existing settings.',
      'Nine shipping connections and seven cable connections add Pacific feeders. Japan, Guam, Hawaii and California gather along broader shared approaches, while selected existing crossings take distinct coastal shoulders. Cable heads are clearer and their wakes remain soft.',
      'The owner’s selected light and activity composition is now the default: brighter Earth light, 176 ships and 186 cable pulses before overall density. Use default sea activity restores its marine activity without resetting your pathway choices. Existing saved compositions keep their values.',
    ...
    review: '527 sea paths and 431 undersea paths are illustrative, not measured traffic or surveyed cable alignments. Original records and endpoints are preserved. Curves and strands are constrained by the existing coarse ocean mask; narrow passages remain schematic. Shared geometry applies across the marine network; added connections focus on selected regions, including European, East Asian and Pacific approaches. This separate Site has its own browser-local saved settings; export and import a composition to carry it across.',
  },
  {
    version: '0.10.17',
    date: '2026-09-17',
    ...
    changes: [
      ...
      'Satellites, flights, ships and cable pulses now arrive over their full intended windows, even with fewer lights selected. The complete Earth reveal returns on every visit; live tuning does not restart arrivals.',
    ],
