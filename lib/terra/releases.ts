...
export const releases = [
  {
    ...
    changes: [
      ...
      'A global marine light balance gives supporting branches more presence, with longer selected Indian and Atlantic hub approaches and a rounder Horn of Africa passage. Default ships rise to 264 and cable pulses to 96, with stronger, more frequent cable glints. Flights and satellites keep their existing settings.',
      'Use livelier seas applies the new marine activity without resetting your route choices. Untouched old marine defaults update once; custom families and saved compositions remain available.',
