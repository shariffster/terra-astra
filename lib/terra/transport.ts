...
const marineActivityKeys=['count','speed','travellerLight','trailLight','tail','pulse','pulseRate','pulseDepth'] as const;
/** An explicit marine-only preset leaves routes, visibility and other families alone. */
export function defaultSeaActivity(value:TransportOptions):TransportOptions {
